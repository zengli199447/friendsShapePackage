 ...
 * remark:
 */
public class ChatFriendAdapter extends RecyclerView.Adapter<MyViewHolder> {

    Context context;
    List<FriendNetBean.ResultBean.FriendBean> list;
    ...
    public ChatFriendAdapter(Context context, List<FriendNetBean.ResultBean.FriendBean> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 1:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chat_friends, parent, false);
                break;
            case 2:
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        if (position == list.size()) {
            ...
            FriendNetBean.ResultBean.FriendBean userBean = list.get(position);
            ...
            SystemUtil.textMagicTool(context, user_content, userBean.getSecondname(),
                    new StringBuffer().append(userBean.getSex()).append("  ").append(userBean.getAge()).
                            append(context.getString(R.string.at_the_age)).toString(), R.dimen.dp14, R.dimen.dp12, R.color.black, R.color.gray_light_text, "\n");
            ...
            OnClickListener(user_img, position);
        }
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkClickListener != null)
                    checkClickListener.onCheckClickListener(v, position);
            }
        });
    }
