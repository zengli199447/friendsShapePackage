...
public class EasyBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
     ...
     * 底部小圆点默认大小
     */
    private final static float POINT_DEFAULT_SIZE = 6f;
    /**
     * 底部小圆点默认间隔距离
     */
    private final static float POINT_DEFAULT_DISTANCE = 16f;
    /**
     * 切换广告的时长  单位：ms
     */
    ...
    private void initData() {
        ...
        for (int i = 0; i < bannerSize; i++) {
            ...
            //设置小圆点的大小
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(SystemUtil
                    .dp2px(getContext(), POINT_DEFAULT_SIZE), SystemUtil.dp2px(getContext(),
                    POINT_DEFAULT_SIZE));

            //除第一个以外，其他小白点都需要设置左边距
            if (i != 0) {
                layoutParams.leftMargin = SystemUtil.dp2px(getContext(), POINT_DEFAULT_DISTANCE / 2);
