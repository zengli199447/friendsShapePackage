 ...
 * remark:
 */
public class StayATeamFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_stay_a_team;
    }

    @Override
    protected void initClass() {
        controllerAllTypeOrder = new ControllerAllTypeOrder(recycler_view,swipe_layout,empty_layout,getActivity().getString(R.string.stay_a_team));
    }
