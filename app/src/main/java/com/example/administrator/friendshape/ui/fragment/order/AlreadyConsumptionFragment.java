 ...
 * remark:
 */
public class AlreadyConsumptionFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_already_consumption;
    }

    @Override
    protected void initClass() {
        controllerAllTypeOrder = new ControllerAllTypeOrder(recyclerView,swipe_layout,empty_layout,getActivity().getString(R.string.already_consumption));
    }
