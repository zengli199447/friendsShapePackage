...
public class AlreadyCancelFragment extends BaseFragment{
    ...
    protected int getLayoutId() {
        return R.layout.fragment_already_cancle;
    }

    @Override
    protected void initClass() {
        controllerAllTypeOrder = new ControllerAllTypeOrder(recycler_view,swipe_layout,empty_layout,getActivity().getString(R.string.cancelled));
    }
